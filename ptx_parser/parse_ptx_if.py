...
#				load_instructions.append(line)
				...
				if (character == ''):
					# If check
					out_ptx.write("\tsetp.lt.u64 \t %maskp1, " + concat_reg + ", " + my_reg_low +";\n")
					out_ptx.write("\tsetp.gt.u64 \t %maskp2, " + concat_reg + ", " + my_reg_high +";\n")
					out_ptx.write("\tor.pred \t %maskp3, %maskp1, %maskp2;\n")
					out_ptx.write("\t@%maskp3 bra \t LBB0_EXIT;\n")
					out_ptx.write(line)
				# if there is +, - in ld and st instructions
					...
					out_ptx.write("\tsetp.lt.u64 \t %maskp1, " + without_arithm + ", " + my_reg_low +";\n")
					out_ptx.write("\tsetp.gt.u64 \t %maskp2, " + without_arithm + ", " + my_reg_high +";\n")
					out_ptx.write("\tor.pred \t %maskp3, %maskp1, %maskp2;\n")
					out_ptx.write("\t@%maskp3 bra \t LBB0_EXIT;\n")
		...
		for line in ptx:
			...
			# Add the extra parameter
				...
				if found_reg == 1:
					...
					new_registers.append("\t.reg .pred \t%maskp<4>;\n")
				...
				if first == 1:
					...
					new_lines.append("\tld.param.u64\t%maskreg1, ["
						...
						+str(par_count)+"];"+"   //argLow"+"\n")
					new_lines.append("\tld.param.u64\t%maskreg2, ["
						+str(current_kernel)+"_param_"
						+str(par_count)+"];"+"   //argHigh"+"\n")
